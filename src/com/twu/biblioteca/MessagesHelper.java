...
public final class MessagesHelper {
    ...
    public static String SearchMovieInLibrary = "Type movie name: ";
    public static String CheckoutMovieSuccess = "Thank you! Enjoy the book";
    public static String CheckoutMovieError = "That book is not available";
    public static String ReturnMovieSuccess = "Thank you for returning the book";
    public static String ReturnMovieError = "That is not a valid book to return";
